...
- **Phạm vi vốn (cập nhật 2026-07-07, co giãn theo tỷ lệ từ 2026-09-23):** mục tiêu GỐC ~$700 vốn xoay vòng + $700 đệm để luân phiên 2 "bucket" (một bucket chờ settle, một bucket sẵn sàng giao dịch) — tổng gốc ~$1400 (tăng từ mốc $400/$800 ban đầu ngày 2026-07-06), tách biệt hoàn toàn khỏi 10 mã core. **Từ 2026-09-23, mục tiêu $700/$700 này KHÔNG còn cố định** mà co giãn theo tỷ lệ tổng giá trị tài khoản thực tế — xem công thức co giãn chung ở mục "Quản trị rủi ro" > "Mục tiêu vốn mỗi vị thế core-10". Mức hiện hành (tính tại 2026-09-23, tỷ lệ co giãn 87.9%): **~$615 vốn xoay vòng + ~$615 đệm** (tổng ~$1,230). Tỷ lệ được tính lại mỗi lần consolidate định kỳ hàng tháng.
...
- **Consolidate vốn hàng tháng (mới, 2026-09-23):** cùng lúc với review thay mã, tính lại tỷ lệ co giãn vốn (công thức ở mục "Quản trị rủi ro" > "Mục tiêu vốn mỗi vị thế core-10") dựa trên tổng giá trị tài khoản tại thời điểm đó, cập nhật mục tiêu $/mã core-10 và $/bucket sandbox tương ứng, ghi rõ tỷ lệ mới + mục tiêu mới vào `trading-log.md`. Không cần ép mua/bán ngay để khớp target mới — chỉ ưu tiên mua thêm mã đang dưới target khi có cash rảnh tự nhiên, tránh giao dịch phát sinh thuế không cần thiết.
